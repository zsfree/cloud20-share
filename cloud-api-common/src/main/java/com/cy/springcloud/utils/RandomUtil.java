...
public class RandomUtil {
    ...
    private static String cars[] = {"单车","卡车","轿车","商务车","皮卡"};
    private static String areas[] = {"华东","华北","华中","华西","华南"};
    private static String provinces[] = {"北京","广东","山东","江苏","河南","上海","河北","浙江","香港","山西","陕西","湖南","重庆","福建","天津","云南","四川","广西","安徽","海南","江西","湖北","山西","辽宁","内蒙古"};
    private static String citys[] = {"北京","广州","临淄","南京","长沙","上海","保定","杭州","九龙","长安","陕西","湖南","重庆","福州","天津","昆明","成都","广西","武汉","三沙","江西","湖北","山西","沈阳","呼尔浩特"};
    ...
    private static Integer sex_id = 0;
     ...
     * @return
     */
    public static Map getCardIDAddress() {
        Map map=new HashMap();
        map.put("name", getChineseName());
        map.put("sex", sex_id);
        map.put("sexStr", name_sex);
        map.put("road", getRoad());
        map.put("tel", getTel());
        map.put("email", getEmail(6,9));
        map.put("birth", randomDate("0000-01-01","2000-01-31"));
        return map;
    }
    ...
    {
        return cars[random.nextInt(10000)%cars.length];
    }
    ...
    {
        return areas[random.nextInt(10000)%areas.length];
    }
    ...
    {
        return provinces[random.nextInt(10000)%provinces.length];
    }
    ...
    {
        return citys[random.nextInt(10000)%citys.length];
    }
