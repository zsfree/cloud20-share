...
public class UploadUtil {
    ...
    private Long height;
    public UploadUtil() { }
    public UploadUtil(String fileType, Long maxSize, Long width, Long height) {
     ...
     * @throws Exception
     */
    public String uploadImage(File upload, String uploadFileName, String path) throws Exception {
        String result = "";
        InputStream is = null;
